              ...
              <>
                ...
                {(session.user as any)?.role === 'admin' && (
                  <>
                    ...
                    <Link href="/admin/subscriptions" className="nav-item nav-item-admin">
                      Subscriptions
                    </Link>
                    <Link href="/admin/plans" className="nav-item nav-item-admin">
                      Plans
                    </Link>
                  </>
                )}
                    ...
                    <>
                      ...
                      <div className="absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100/50 overflow-hidden z-20 backdrop-blur-xl" style={{
                        ...
                        <div className="py-2">
                          ...
                          <Link href="/bookmarks" className="group flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200" onClick={() => setIsUserMenuOpen(false)}>
                            <div className="flex items-center justify-center w-8 h-8 bg-gray-100 rounded-lg mr-3 group-hover:bg-yellow-100 group-hover:text-yellow-600 transition-all duration-200">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                              </svg>
                            </div>
                            <div className="flex-1">
                              <p className="font-medium">Bookmarked Questions</p>
                              <p className="text-xs text-gray-500">Your saved study questions</p>
                            </div>
                          </Link>
                          
                          <Link href="/subscription" className="group flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200" onClick={() => setIsUserMenuOpen(false)}>
