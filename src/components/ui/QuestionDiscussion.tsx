  ...
  if (isCollapsed && !isMobile) {
    return (
      <button
        ...
        className="fixed top-1/2 right-4 transform -translate-y-1/2 w-12 h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-all duration-300 z-50 flex items-center justify-center"
